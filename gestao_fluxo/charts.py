...
def relogio_meta(percentual: float, titulo: str, detalhe: str) -> dict:
    ...
    return {
        ...
        "series": [{
            ...
            "min": 0, "max": 100, "center": ["50%", "55%"], "radius": "88%",
            "progress": {"show": True, "width": 22, "itemStyle": {"color": cor}},
            "axisLine": {"lineStyle": {"width": 22, "color": [[1, "#1E2731"]]}},
            "pointer": {"width": 6, "length": "52%", "itemStyle": {"color": cor}},
            "axisTick": {"show": False},
            "splitLine": {"length": 14, "lineStyle": {"width": 2, "color": "#2E3A47"}},
            # Escala numérica (0…100) escondida: era ela que sobrepunha o "faltam X".
            "axisLabel": {"show": False},
            "anchor": {"show": True, "size": 16, "itemStyle": {"color": cor}},
            "title": {"offsetCenter": [0, "40%"], "fontSize": 15, "color": MUTED},
            "detail": {
                "offsetCenter": [0, "-12%"], "fontSize": 40, "fontWeight": "bolder",
