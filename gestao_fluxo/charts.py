...
def relogio_meta(percentual: float, titulo: str, detalhe: str) -> dict:
    ...
    return {
        ...
        "series": [{
            ...
            "min": 0, "max": 100, "center": ["50%", "58%"], "radius": "72%",
            "progress": {"show": True, "width": 18, "itemStyle": {"color": cor}},
            "axisLine": {"lineStyle": {"width": 18, "color": [[1, "#1E2731"]]}},
            "pointer": {"width": 5, "length": "55%", "itemStyle": {"color": cor}},
            "axisTick": {"show": False},
            "splitLine": {"length": 12, "lineStyle": {"width": 2, "color": "#2E3A47"}},
            "axisLabel": {"distance": 20, "fontSize": 12, "color": MUTED},
            "anchor": {"show": True, "size": 14, "itemStyle": {"color": cor}},
            "title": {"offsetCenter": [0, "32%"], "fontSize": 14, "color": MUTED},
            "detail": {
                "offsetCenter": [0, "-8%"], "fontSize": 34, "fontWeight": "bolder",
